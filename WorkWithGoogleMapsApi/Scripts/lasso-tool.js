...
function initialize() {
    var latlng = new google.maps.LatLng(42.755935, 25.119599);
    var myOptions = { zoom: 7, center: latlng, mapTypeId: google.maps.MapTypeId.HYBRID, draggableCursor: 'crosshair', mapTypeControlOptions: { style: google.maps.MapTypeControlStyle.DROPDOWN_MENU } };
...
function SearchPointsAdd() {
    ...
    if (!(polygon == undefined)) {
        ////hide markers when there is selected area
        //if (randomMarkers) {
